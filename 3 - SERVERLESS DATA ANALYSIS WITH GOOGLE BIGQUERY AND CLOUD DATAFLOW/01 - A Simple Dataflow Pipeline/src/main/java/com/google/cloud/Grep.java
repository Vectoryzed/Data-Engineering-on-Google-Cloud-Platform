...
public class Grep {
	...
	public static void main(String[] args) {
		...
		//This variabiles must be set as input/output if the Dataflow pipeline is deployed on cloud
		//String input = "gs://qwiklabs-gcp-your-value/*.java";
		...
		p //
				...
				.apply("Grep", ParDo.of(new DoFn<String, String>() { //first/second elements (String) are the returned input/output type
					@ProcessElement
				...
				// withoutSharding() forces a single file as output
